$(document).ready(function (){
    $("#btnInserirTelefone").click(function (event){
        event.preventDefault();
        if(!$("#modalTelefoneCreate").length){
            $('body').append('  <div class="modal fade" id="modalTelefoneCreate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">\n\
